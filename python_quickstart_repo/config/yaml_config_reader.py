...
class ConsumerConfig:
    ...
    def __eq__(self, other):
        return (
            isinstance(other, ConsumerConfig)
            and self.kafka_consumer_configs == other.kafka_consumer_configs
            and self.topic_postgresql_config_dict == other.topic_postgresql_config_dict
        )
...
class ProducerConfig:
    ...
    def __init__(self, kafka_producer_config: KafkaProducerConfig, page_fetcher_configs: list[PageFetcherConfig]):
        self.kafka_producer_configs = kafka_producer_config
        self.page_fetcher_configs = page_fetcher_configs

    def __eq__(self, other):
        return (
            isinstance(other, ProducerConfig)
            and self.kafka_producer_configs == other.kafka_producer_configs
            and self.page_fetcher_configs == other.page_fetcher_configs
        )
...
class ProgramConfig:
    ...
    def __eq__(self, other):
        return (
            isinstance(other, ProgramConfig)
            and self.general_config == other.general_config
            and self.producer_config == other.producer_config
            and self.consumer_config == other.consumer_config
        )
